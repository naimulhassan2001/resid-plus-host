...
WeeklyIncomeModel weeklyIncomeModelFromJson(String str) => WeeklyIncomeModel.fromJson(json.decode(str));

String weeklyIncomeModelToJson(WeeklyIncomeModel data) => json.encode(data.toJson());
...
class WeeklyIncomeModel {
  ...
  factory WeeklyIncomeModel.fromJson(Map<String, dynamic> json) => WeeklyIncomeModel(
