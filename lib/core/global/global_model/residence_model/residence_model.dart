...
class Residences {
  ...
  Residences.fromJson(dynamic json) {
    ...
    _acceptanceStatus = json['acceptanceStatus'];
    _createdAt = json['createdAt'];
    _updatedAt = json['updatedAt'];
    _v = json['__v'];
    _feedBack = json['feedBack'];
    _reUpload = json['reUpload'];
  }
  String? _id;
  int ?_likes;
  int ?_views;
  ...
  String? get acceptanceStatus => _acceptanceStatus;
  String? get createdAt => _createdAt;
  String? get updatedAt => _updatedAt;
  int? get v => _v;
  dynamic get feedBack => _feedBack;
  bool? get reUpload => _reUpload;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['acceptanceStatus'] = _acceptanceStatus;
    map['createdAt'] = _createdAt;
    map['updatedAt'] = _updatedAt;
    map['__v'] = _v;
    map['feedBack'] = _feedBack;
    map['reUpload'] = _reUpload;
    return map;
  }
